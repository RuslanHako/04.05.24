...
window.addEventListener('load', function () {
    setTimeout(function () {
        var loader = document.querySelector('.loader'); // Находим элемент
        прелоадера
        ...
        setTimeout(function () {
            loader.style.display = 'none'; // Скрываем прелоадер после окончания 
            анимации
            loader.style.zIndex = 'auto'; // Установка z-index для прелоадера на 
            автоматический
